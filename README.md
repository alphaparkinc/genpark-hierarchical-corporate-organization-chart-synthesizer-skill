# genpark-hierarchical-corporate-organization-chart-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Hierarchical corporate organization chart synthesizer & DAG tree (AI Org Chart)
